...
import { ActualFileUpload, DropFileUploadText, DropFilesHereOrClickToUpload, UploadInstructorFiles } from '@/Constant';
import { Dropzone, FileMosaic, ExtFile } from "@dropzone-ui/react";
import { useState } from 'react';

const UploadInstructorFile = () => {
  ...
  return (
    <Row>
      <Col>
        <FormGroup>
          <Label check>{UploadInstructorFiles}</Label>
...
export default UploadInstructorFile