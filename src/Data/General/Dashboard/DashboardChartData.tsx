...
export const newProjectChartData: ApexOptions = {
  ...
  colors: [secondary, "#f6ecf8", secondary, "#f6ecf8", secondary, "#f6ecf8", secondary, "#f6ecf8"],
  chart: {
    height: 85,
    type: "bar",
    sparkline: {
...
export const monthlyOverviewChartData: ApexOptions = {
  series: [
    {
      name: "Cash Flow",
      data: [-66, 50, 150, 66, 50, 150, -79, -50, -136, -54, -40, -140, 79, 49, -150, -70, 50, 140, 60, 44, 130, -66, -30, -130, -70, -50],
    },
  ],
  chart: {
    type: "bar",
...
export const totalEarningChartData: ApexOptions = {
  ...
  colors: ["rgba(244, 245, 248, 0.85)", "rgba(244, 245, 248, 0.85)", "rgba(244, 245, 248, 0.85)", primary],
  plotOptions: {
    bar: {
      columnWidth: "45%",
      distributed: true,
...
export const salesSummaryChartData: ApexOptions = {
  series: [
    {
      name: "Revenue",
      data: [23, 11, 22, 27, 13, 22, 37, 21, 44, 22, 30, 23, 11, 22, 27, 13, 22, 37, 21, 44, 22, 30, 23, 11, 22, 27, 13, 22, 37, 21, 44, 22, 30, 23, 11, 22, 27, 13, 22, 37, 21, 44, 22, 30],
    },
  ],
  chart: {
    type: "bar",
