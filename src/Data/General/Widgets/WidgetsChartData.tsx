...
export var monthlyHistoryChart: ApexOptions = {
  ...
  colors: [secondary, "#FD7E40", primary],
  fill: {
    type: "gradient",
    gradient: {
      shade: "light",
...
export var usesChart: ApexOptions = {
  ...
  colors: [primary, secondary, "#0077B5", "#FD7E40"],
  title: {
